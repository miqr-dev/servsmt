      ...
      <div class="col-12 mx-auto">
       <!-- Profile Image -->
        <div class="card card-primary card-outline" id="content">
          ...
          <img src="/images/admin_images/santa.png" class="ribbonCenter" style="max-width: 25%; max-height: 25%;"   alt="">
              ...
              <div class="card-header text-center font-weight-bold" style="color:#661421;">
               Neu - Anforderungen
                 ...
                 <ul class="list-group list-group-flush">
                  ...
                  <div class="card-body list-group-item" >
                    <h5 class="text-center" style="color: #0284c7;"><u>Hardewarebedarf</u></h5>
                    <ul class="list-unstyled text-center">
                      <a href="{{route('peripheralRequest')}}"><li>Maus | Tastatur | Kopfhörer</li>
                      <li>Webcam | Lautsprecher</li></a>
                      <a href="{{route('hardwareRequest')}}"><li>PC | Laptop | Tablet</li>
