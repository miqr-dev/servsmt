<div class="invoice col-md-12 p-3 mb-3">
  ...
  <div class="row invoice-info">
    ...
    <div class="col-sm-4 invoice-col">
      Software
      <address>
        <u class="mt-1"><strong>{{@$ticket->searchsoftware}}</strong></u><br>
      </address>
    </div>
    <div class="col-sm-4 invoice-col">
      software link
      <address>
        <u class="mt-1"><strong>{{@$ticket->software_name}}</strong></u><br>
      </address>
    </div>
    <div class="col-sm-4 invoice-col">
      Grund
      <address>
        <u class="mt-1"><strong>{{@$ticket->software_reason}}</strong></u><br>
      </address>
    </div>
