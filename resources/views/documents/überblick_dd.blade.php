    ...
    <div class="container mx-auto mt-10" style="width: 100%;">
        ...
        <div class="table-container mt-6">
            <table class="w-full border-collapse border border-black text-base">
                <tr>
                    <td class="p-3 border border-black" rowspan="2">Theorie Ausbildung</td>
                    <td class="p-3 border border-black">Lernfelder gem. Rahmenlehrplan</td>
                    <td class="p-3 border border-black" rowspan="2">880 Std.<br>88 Std.</td>
                </tr>
                <tr>
                    <td class="p-3 border border-black">Kopfstunden</td>
                </tr>
                <tr>
                    <td class="p-3 border border-black align-top">Berufspraktische Ausbildung</td>
                    <td class="p-3 border border-black">
                        <ul class="list-disc pl-5">
                            <li>außerbetriebliche Ausbildung intern</li>
                            <li>Kaufmännisches Übungsbüro</li>
                            <li>Handlungsorientierte Lerneinheiten WQ</li>
                            <li>Spezialisierung</li>
                        </ul>
                    </td>
                    <td class="p-3 border border-black">{{ $stunden_außerbetriebliche_ausbildungsstätte }} Std.</td>
                </tr>
                <tr>
