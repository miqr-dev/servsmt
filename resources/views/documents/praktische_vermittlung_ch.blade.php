...
<body class="font-sans text-sm leading-relaxed">
  ...
  <div class="container mx-auto my-8">
    ...
    <table class="w-full border-collapse">
      <thead>
        <tr>
          <th class="border border-black p-1 text-center">Während der gesamten Ausbildungszeit</th>
          <th class="border border-black p-1 text-center">Praktikum</th>
          <th class="border border-black p-1 text-center">Berufspraktische Ausbildung</th>
        </tr>
      </thead>
      <tbody>
        <tr>
  ...
  <div class="container mx-auto my-2">
    <table class="w-full border-collapse">
      <thead>
        <tr>
          <th class="border border-black p-1 text-center">1. bis 10. Ausbildungsmonat</th>
          <th class="border border-black p-1 text-center">Praktikum</th>
          <th class="border border-black p-1 text-center">Berufspraktische Ausbildung</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td class="border-l border-r border-black p-1 bg-gray-400"><span class="bg-gray-400 font-bold ">ZEITRAHMEN 2,6
              - 4 MONATE</span></td>
          <td class="border-l border-r border-black p-1" style="vertical-align: middle; text-align: center;"
            rowspan="6"></td>
          <td class="border-l border-r border-black p-1" style="vertical-align: top; text-align: center;" rowspan="6">
            370 Stunden</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="border-l border-r border-black p-1" style="vertical-align: top; text-align: center;" rowspan="5">
            370
            Stunden</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="border-l border-r border-b border-black p-1" style="vertical-align: middle; text-align: center;"
            rowspan="3"></td>
          <td class="border-l border-r border-b border-black p-1" style="vertical-align: top; text-align: center;" rowspan="3">
            370 Stunden</td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="border-l border-r border-b border-black p-1">Absatz 4 Nummer 1.2<br>Produkt- und Dienstleistungsangebot</td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  <div class="container mx-auto my-2">
    <table class="w-full border-collapse">
      <thead>
        <tr>
          <th class="border border-black p-1 text-center">11. bis 24. Ausbildungsmonat</th>
          <th class="border border-black p-1 text-center">Praktikum</th>
          <th class="border border-black p-1 text-center">Berufspraktische Ausbildung</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td class="border-l border-r border-black p-1 bg-gray-400"><span class="bg-gray-400 font-bold ">ZEITRAHMEN 6,6
              MONATE</span></td>
          <td class="border-l border-r border-black p-1" style="vertical-align: middle; text-align: center;"
            rowspan="6"></td>
          <td class="border-l border-r border-black p-1" style="vertical-align: top; text-align: center;" rowspan="6">
        ...
        <tr>
          <td class="border-l border-r border-black p-1">Absatz 4 Nummer 3.2<br>Kommunikation</td>
        </tr>
              <tr>
          <td class="border-l border-r border-black p-1 bg-gray-400"><span class="bg-gray-400 font-bold ">ZEITRAHMEN 6 MONATE (2 Wahlqualifikationen)</span></td>
          <td class="border-l border-r border-b border-black p-1" style="vertical-align: top; text-align: center;"
            rowspan="9">1008 Stunden</td>
          <td class="border-l border-r border-b border-black p-1" style="vertical-align: top; text-align: center;" rowspan="9">
            </td>
        </tr>
        <tr>
