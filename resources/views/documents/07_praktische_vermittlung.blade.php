...
<head>
  ...
  <style>
    ...
    .container {
      margin-bottom: 50px;
      /* Ensure footer is correctly positioned */
    }
  </style>
</head>
  ...
  <div class="container mx-auto my-8">
    ...
    <div class="my-6">
      <table class="w-full">
        ...
        <tr>
          <td class="text-left"><strong>Handlungsorientierte Lerneinheiten:</strong></td>
          <td class="text-right">{{ $hol_beginn }} – {{ $hol_ende }}</td>

        </tr>
        <tr>
          <td class="text-left"><strong>Praktikum:</strong></td>
    ...
    <table class="w-full border-collapse">
      ...
      <tbody>
        <tr>
          ...
          <td class="border-l border-r border-b border-black p-1 text-center"
            style="vertical-align : middle;text-align:center;" rowspan="16">266 Stunden</td>
          <td class="border-l border-r border-b border-black p-1" style="vertical-align : middle;text-align:center;"
            rowspan="16"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="border-l border-r border-black p-1">Absatz 4 Nummer 1.1<br>Stellung, Rechtsform<br>und
      ...
      <tbody>
        <tr>
          ...
          <td class="border-l border-r border-b border-black p-1" style="vertical-align : middle;text-align:center;"
            rowspan="8"></td>
          <td class="border-l border-r border-b border-black p-1" style="vertical-align : middle;text-align:center;"
            rowspan="8">Pro Wahlqualifikation 336 Stunden</td>
        </tr>
        <tr>
