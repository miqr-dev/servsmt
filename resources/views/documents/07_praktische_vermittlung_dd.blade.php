        ...
        <table class="w-full border-collapse">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-l border-r border-b border-black p-1 text-center" rowspan="8" style="vertical-align: middle; text-align: center;">70 Stunden</td>
                    <td class="border-l border-r border-b border-black p-1" style="vertical-align: middle; text-align: center;" rowspan="8"></td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 1.4<br>arbeits-, sozial-, mitbestimmungsrechtliche und tarif- oder beamtenrechtliche Vorschriften</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 1.5<br>Sicherheit und Gesundheitsschutz bei der Arbeit</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 1.6<br>Umweltschutz</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 1.7<br>wirtschaftliches und nachhaltiges Denken und Handeln</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 2.4<br>qualitätsorientiertes Handeln in Prozessen</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 3.3<br>Kooperation und Teamarbeit</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-b border-black p-1">Absatz 4 Nummer 3.4<br>Anwenden einer Fremdsprache bei Fachaufgaben</td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <table class="w-full border-collapse">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-l border-r border-b border-black p-1" style="vertical-align: middle; text-align: center;" rowspan="16"></td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 2 Nummer 1.2<br>Informationsverarbeitung</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 1.1<br>Stellung, Rechtsform und Organisationsstruktur</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 2.3<br>Datenschutz und Datensicherheit</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 3.1<br>Informationsbeschaffung und Umgang mit Informationen</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 2 Nummer 1.3<br>bürowirtschaftliche Abläufe</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 2 Nummer 1.4<br>Koordinations- und Organisationsaufgaben</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 2.1<br>Arbeits- und Selbstorganisation, Organisationsmittel</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 4 Nummer 2.2<br>Arbeitsplatzergonomie</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 2 Nummer 2.3<br>Beschaffung von Material und externen Dienstleistungen</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 2 Nummer 2.2<br>Auftragsbearbeitung und -nachbereitung</td>
                </tr>
                <tr>
        ...
        <table class="w-full border-collapse">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-l border-r border-b border-black p-1" style="vertical-align: middle; text-align: center;" rowspan="8"></td>
                    <td class="border-l border-r border-b border-black p-1 text-center" style="vertical-align: middle; text-align: center;" rowspan="8">Pro Wahlqualifikation 336 Stunden</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 3 Nummer 2<br>kaufmännische Steuerung und Kontrolle</td>
                </tr>
                <tr>
                    <td class="border-l border-r border-black p-1">Absatz 3 Nummer 3<br>kaufmännische Abläufe in kleinen und mittleren Unternehmen</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="border-l border-r border-b border-black p-1">Absatz 3 Nummer 8<br>Öffentlichkeitsarbeit und Veranstaltungsmanagement</td>
                </tr>
            </tbody>
        </table>
    </div>
