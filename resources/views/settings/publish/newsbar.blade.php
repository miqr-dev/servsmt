      ...
      <div class="col-12 mx-auto">
        <div class="card card-primary card-outline">
          <div class="card-body box-profile form-group">
            <form action="{{ route('newsbar.update',$newsbar->id) }}" method="POST">
              @csrf
              @method('PUT')
            <!-- child cards -->
                  ...
                  <div class="card-body box-profile form-group">       
                    <div class="row col-md-12">
                      <div class="custom-control custom-checkbox col-md-3">
                        <input type="checkbox" class="custom-control-input" id="isNewsBar" name="isNewsBar" 
                        {{ $newsbar->isNewsBar === 'on' ? 'checked' : '' }}
                        >
                        <label class="custom-control-label" for="isNewsBar">Publizieren</label>
                      </div>
                      <div class="col-md-3">
                        @if($newsbar->isNewsBar === 'on')
                        <div>
                    ...
                    <div class="row col-md-12 mt-4">  
                      <div class="form-group col-md-12">
                        ...
                        <textarea type="text" name="name" class="form-control" required autocomplete="false">{{@$newsbar->name}}</textarea>
                      </div>
                    </div>             
                    <div>
