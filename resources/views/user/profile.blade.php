                    ...
                    <div class="card card-primary card-outline">
                      <div class="card-body box-profile form-group">
                        ...
                        <div class="form-group row border-bottom">
                          <label for="position" class="col-lg-6 col-form-label"><strong><i class="fas fa-user-tie" style="color: #A8535F;"></i></strong> Tätigkeit </label>
                            <div class="col-lg-6">
                      ...
                      <div class="card-body box-profile form-group">
                        ...
                        <div class="form-group row border-bottom">
                          ...
                          <label for="vorname" class="col-lg-6 col-form-label"><strong><i class="far fa-user fa-lg" style="color: #A8535F;"></i></strong> Vorname</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control mb-2" name="vorname" value=" {{old('vorname') ?? $user->vorname}}" readonly>
                            </div>
                          <label for="name" class="col-lg-6 col-form-label"><strong><i class="far fa-user fa-lg" style="color: #A8535F;"></i></strong> Name</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control mb-2" name="name" value=" {{old('name') ?? $user->name}}" readonly>
                            </div>
                        </div>
                        <!-- Mobil -->
                        <div class="form-group row border-bottom">
