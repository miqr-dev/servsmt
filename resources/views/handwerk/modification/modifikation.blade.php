...
@section('content')
@include('tickets.layout_ticket.header',['title'=>'Modifikation'])
            ...
            <form action="{{route ('form_store_handwerk')}}" method="post">
              ...
              <div class="row mx-auto">
                ...
                <div class="col-lg-8">
                  <div class="card card-secondary card-outline">
                    <div id="underform">
                      <input type="hidden" name="problem_type" value="Modifikation">
                      <div class="card-body box-profile form-group">
                        <div class="row">
                        ...
                        <div class="form-group mt-4">
                          ...
                          <input type="text" name="subject" class="form-control subject"></input>
                        </div>
                        <div class="form-group mt-4">
