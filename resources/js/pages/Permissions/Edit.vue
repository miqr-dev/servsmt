...
type Permission = {
    id: number;
    name: string;
    permissioncategory_id: number | null;
};
...
const form = useForm<{ name: string; permissioncategory_id: string }>({
    ...
    permissioncategory_id: props.permission.permissioncategory_id
        ? String(props.permission.permissioncategory_id)
        : '',
});
...
<template>
    <Head title="Permission bearbeiten" />
